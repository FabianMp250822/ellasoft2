...
let mockOrganizations: Organization[] = [
    { id: "org_1", name: "Greenwood High", admin: "Alice Martin", email: "alice.m@greenwood.edu", status: "Active", createdAt: "2023-10-01", logoUrl: "https://placehold.co/40x40.png" },
    { id: "org_2", name: "Oak Valley Academy", admin: "David Chen", email: "d.chen@oakvalley.org", status: "Active", createdAt: "2023-09-15", logoUrl: "https://placehold.co/40x40.png" },
    { id: "org_3", name: "Maple Creek Institute", admin: "Sophia Rodriguez", email: "sophia.r@maple.edu", status: "Inactive", createdAt: "2024-01-20", logoUrl: "https://placehold.co/40x40.png" },
];
